<head>
    <title>Hellow Admin Panel Installation V2.0</title>
...
<body class="">
    ...
    <div class="container-fluid fluid menu-left">
        ...
        <div class="navbar main hidden-print">
            ...
            <!-- Brand -->
            <a href="#" style="width:50%" class="appbrand pull-left"><span>Hellow Admin Panel Installation Wizards<span>V2.0</span></span></a>

            <!-- Menu Toggle Button -->
            <a href="#" class="appbrand pull-right"><span>Installation Agent <span>v1.2.0</span></span></a>
